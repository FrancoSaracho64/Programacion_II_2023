...
int main(){
    ...
    printf("La complejidad algoritmica de este ejercicio es del tipo O(n^2) ya que, en  el\npeor de los casos, dentro de la funcion, se va a recorrer la  cola  hasta  que\neste vacia, y, por cada elemento, se va a  recorrer  la  pila  hasta que  este\nvacia. Se va a comparar cada elemento de  ambas  estructuras  para  asi  poder\ndeterminar si son iguales o no.");
    printf("\n------------------------------------------------------------------------------\n\n\n");
