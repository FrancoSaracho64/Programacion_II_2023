    ...
    do{
        ...
        switch (opcion) {
            ...
            case 2: // Determinar el nivel de un nodo. 
                ...
                printf("La altura del nodo es: %d", altura_nodo);
                printf("\n********************************************\n\n");
                break;
            ...
            case 4: // Determinar si todas las hojas están al mismo nivel.
                ...
                if (resultado_4) printf("Todas las hojas del arbol tienen el mismo nivel.");
                else printf("Las hojas del arbol se encuentran en niveles variados.");
                printf("\n********************************************\n\n");
                break;
            case 0:
