...
int main(){
    ...
    printf("------------------------------------------------------------------------------\nCOMPLEJIDAD ALGORITMICA: \n");
    printf("La  complejidad  algoritmica de  este ejercicio seria O(n^2),  ya  que  en  la\nfuncion que realizamos para resolver el ejercicio  vamos a recorrer  una  pila\nhasta que esta se  encuentre  vacia, y  por  cada  elemento de esta,  vamos  a\nrecorrer la misma pila pero sin  el  primer  elemento,  para  poder extraer la\ncantidad de divisores parciales y/o totales.");
    printf("\n------------------------------------------------------------------------------\n\n\n");
